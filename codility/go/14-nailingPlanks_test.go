...
func Test_nailingPlanks(t *testing.T) {
	A := []int{1, 4, 5, 8}
	B := []int{4, 5, 9, 10}
	C := []int{4, 6, 7, 10, 2}
	...
	tests := []struct {
		...
		{A, B, C, 4},
		{[]int{1, 1, 1, 2, 1}, []int{5, 5, 5, 5, 4}, []int{1, 2, 3, 4, 5}, 2},
		{
			[]int{28, 18, 43, 15, 26, 18, 21, 49, 6, 23, 12, 18, 50, 17, 31, 21, 37, 23, 9, 22, 21, 40, 29, 10, 34, 15, 26, 11, 21, 40, 26, 38, 38, 30, 33, 20, 31, 39, 5, 47, 19, 7, 8, 18, 4, 20, 21, 33, 24, 47, 33, 17, 44, 35, 49, 37, 49, 11, 14, 49, 2, 47, 46, 7, 8, 46, 48, 44, 37, 38, 16, 1, 32, 45, 48, 26, 1, 9, 23, 12, 2, 10, 25, 7, 6, 9, 2, 40, 44, 11, 32, 44, 13, 17, 45, 39, 32, 40, 29, 16},
	...
	for i, tt := range tests {
		r := nailingPlanks(tt.A, tt.B, tt.C)
		if r != tt.want {
